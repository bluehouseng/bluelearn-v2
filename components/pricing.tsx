      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-8">
            <h2 className="h2 font-cabinet-grotesk">Start Your Career Today</h2>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center max-w-[10rem] m-auto mb-8 lg:mb-14">
              <div className="relative flex w-full p-1 bg-gray-100 rounded-full">
                ...
                >
                  <span
                    className={`absolute inset-0 w-1/2 bg-blue-500 rounded-full shadow-sm transform transition duration-150 ease-in-out ${
                      annual ? "translate-x-full" : "translate-x-0"
                    }`}
                  />
                </span>
                <button
                  className={`relative flex-1 text-sm font-cabinet-grotesk font-bold h-8 transition duration-150 ease-in-out ${
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
              {/* Pricing table 1 */}
              <div
                className="relative flex flex-col h-full p-6 rounded"
                data-aos="fade-up"
                data-aos-delay="100"
              >
                <div className="mb-6">
                ...
                <ul className="text-gray-500 space-y-3 grow">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>
                      Access to our private Discord with 1,000+ members
                    </span>
                  </li>
                  <li className="flex items-center">
                    <svg
              ...
              >
                <div className="mb-6">
                  ...
                  <div className="text-gray-500 mb-6">
                    You're committed to getting hired and starting a career in
                    tech
                  </div>
                  <Link
