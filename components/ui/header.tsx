        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link className="block group" href="/" aria-label="Cruip">
              <h1
                className="h3 font-cabinet-grotesk text-white mb-2"
                data-aos="fade-up"
              >
                Bluelearn<span className="text-yellow-500">.</span>
              </h1>
          ...
          <nav className="flex grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              {/* <li>
                <Link
                  className="font-cabinet-grotesk text-sm font-bold text-white underline hover:no-underline flex items-center border p-2 rounded-lg"
                  href="/signin"
                >
                  Sign in
                </Link>
              ...
              <li className="ml-6">
                <Link
                  className="btn-sm inline-flex items-center text-white group border border-white"
                  href="https://sso.teachable.com/secure/2181591/identity/login"
                >
                  Signin
                </Link>
              </li>
