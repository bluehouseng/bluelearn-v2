...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-hero-img bg-cover bg-no-repeat ">
      <div className="w-full mx-auto px-4 sm:px-6 bg-black/60">
        <div className="pt-28 pb-16 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p
              ...
              data-aos-delay="100"
            >
              Empowerment | Inclusivity | Global Connectivity
            </p>
            <div data-aos="fade-up" data-aos-delay="200">
              <Link
                className="btn inline-flex items-center border border-white text-white bg-gray-900 hover:bg-gray-800 group"
                href="https://sso.teachable.com/secure/2181591/identity/login/password"
              >
                Apply Now
