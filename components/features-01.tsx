...
import Carousel01 from "@/public/images/tims.jpg";
import Carousel02 from "@/public/images/me.png";
import Carousel03 from "@/public/images/sam.png";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-16">
            <h2 className="h2 font-cabinet-grotesk text-white">
              Learn from the Best: Courses Taught by Industry Experts, CTOs, and
              Seasoned Engineers.
            </h2>
          </div>
          ...
          <div className="pb-12 md:pb-16">
            ...
            <div className="carousel swiper-container max-w-sm mx-auto sm:max-w-none">
              <div className="swiper-wrapper">
                {/* Carousel items */}
                <div className="swiper-slide max-w-[446px] h-auto border border-white rounded-lg shadow-lg overflow-hidden relative">
                  {/* Image */}
                  <Image
                    ...
                    alt="Carousel 01"
                  />
                  <div className="absolute w-full h-full z-50 bg-black flex justify-center items-center">
                    Social Media
                  </div>
                </div>
