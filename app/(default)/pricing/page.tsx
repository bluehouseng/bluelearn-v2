          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
            ...
            >
              <div className="mb-6">
                ...
                <button
                  ...
                  onClick={() => {
                    setSelected({ ...selected, amount: 100000, type: "basic" });
                    setShowModal(true);
                  }}
                >
                  Start Learning
            ...
            >
              <div className="mb-6">
                ...
                <button
                  ...
                  onClick={() => {
                    setSelected({ ...selected, amount: 200000, type: "pro" });
                    setShowModal(true);
                  }}
                >
                  Start Learning Now
            ...
            >
              <div className="mb-6">
                ...
                <button className="btn w-full inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group">
                  Schedule A Call
                  <span className="tracking-normal text-blue-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-2">
                    <svg
                      className="fill-current"
